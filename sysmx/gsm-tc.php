...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            <div class="box-head">
                <h3 class="title">GSM - TCKN Sorgu</h3>
            </div>
            <div class="row">
                            ...
                            <div class="row mbn-20">
                               ...
                               <div class="col-lg-12 col-12 mb-20">
                                    <div class="row mbn-15">
                                        ...
                                        <div id="tc">
                                                            <input required="required" type="text" maxlength="11" class="form-control" id="gsm" placeholder="___________" data-mask="9999999999" name="gsm"/><br>
                                                            <center>
        ...
        <tbody>
			...
			$sql = "SELECT * FROM `120mgsm` WHERE `GSM` = '$str'";
