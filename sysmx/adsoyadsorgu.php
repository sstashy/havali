...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            <div class="box-head">
                <h3 class="title">Ad Soyad Sorgu</h3>
            </div>
            <div class="row">
                               ...
                               <div class="col-lg-12 col-12 mb-20">
                                    <div class="row mbn-15">
                                        ...
                                        <div id="tc">
                                                            ...
                                                            <input require maxlength="30" style="display:none;" class="form-control" type="text" name="tcText" id="tcText" placeholder="Ad">
														  <input required="required" type="text" maxlength="20" class="form-control" id="nufusil" placeholder="Nüfus İl"  name="nufusil"/><br>
                                                            <center>
        ...
        <tbody>
         ...
         $sql = "SELECT * FROM 101m WHERE ADI = '$ad' AND SOYADI = '$soyad' AND NUFUSIL = '$nufusil'";
