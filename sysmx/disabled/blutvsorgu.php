...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            <div class="box-head">
                <h3 class="title">Blutv Checker</h3>
            </div>
            <div class="row">
                            ...
                            <div class="row mbn-20">
                                ...
                                <div class="col-lg-12 col-12 mb-20">
                                    <div class="row mbn-15">
                                        <div class="col-12">
                                            <div class="col mb-15">
                                                <label for="tel" style="color:#fff;">Combolist</label>
                                                <textarea class="form-control" id="combolist" placeholder="mail@gmail.com:şifre" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>
                                            </div>
                                        </div>
