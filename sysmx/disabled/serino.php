...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            <div class="box-head">
                <h3 class="title">T.C. PRO (SERİNO) Sorgu</h3>
            </div>
            <div class="row">
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>SOYAD</th>
                                                <th>SERİ NO</th>
                                                <th>CİLTNO/AİLENO/SIRANO</th>
                                                <th>DOĞUMYERİ</th>
                                                <th>ANNE AD</th>
                                                <th>BABA AD</th>
                                                <th>MEDENIHALI/DINI</th>
                                                <th>NÜFUS İL/İLÇE/MAHALLE</th>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == "empty") {
                    ...
                    return swal({
                        title: "API tarafından cooldowna düştü. 10 Saniye sonra tekrar deneyiniz.",
                        icon: "warning"
