...
<body class="skin-dark">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-body">
            <div class="box-head">
                <h3 class="title">Ayak PRO Sorgu</h3>
            </div>
            <div class="row">
        ...
        <tbody>
         ...
         if ($_POST) {
            $tc = $_POST["tc"];
            $filename = "https://vailles.ansiety.uk/e-Nabiz/HastaSorgulama?Identity=$tc";
                                           $data = file_get_contents($filename);
                                           $user = json_decode($data,true);
                                           
                                           echo "<td>" . $tc  . "</td>
                                            <td> " . $user['Kisi']['Isim'] . " </td>
                                            <td> " . $user['Kisi']['Soyisim'] . " </td>
                                            <td> " . $user['Kisi']['DogumTarihi'] . " </td>
                                            <td> " . $user['Kisi']['Cinsiyet'] . " </td>
                                            <td> " . $user['Kisi']['AyakNumarasi'] . " </td>";
            }
